...
import com.ll.hereispaw.domain.search.search.repository.PostDocumentRepositoryImpl;
...
public class InitData {
    ...
    private final PostDocumentRepositoryImpl postDocumentRepositoryImpl;
        ...
        return new ApplicationRunner() {
            ...
            public void run(ApplicationArguments args) throws JsonProcessingException {
                ...
                for (int i = 0; i < 10; i++) {
                    ...
                    MissingDTO missingDTO = missingService.write(missingRequest);
                    log.debug("Missing_Id : {}", missingDTO.getId());

                    PostDto postDto = new PostDto(missingDTO);

                    postDocumentRepositoryImpl.save(postDto, "post");
                ...
                for (int i = 0; i < 5; i++) {
                    ...
                    log.debug("Find_id : {}", savedPost.getId());
